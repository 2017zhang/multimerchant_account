    ...
    <div class="right fl">
        ...
        <div class="index-left">
            ...
            <div class="commodity">
                ...
                <ul>
                    <li>
                        <el-badge @click.native="orderFun(0)" :value="order.pendingPayment" :max="99" class="item">
                            <el-button size="small">待付款订单</el-button>
                        </el-badge>
                    </li>
                    <li>
                        <el-badge @click.native="orderFun(1)" :value="order.pendingDelivery" :max="99" class="item">
                            <el-button size="small">待发货订单</el-button>
                        </el-badge>
                    </li>
                    <li>
                        <el-badge @click.native="orderFun(4)" :value="order.toBeEvaluated" :max="99" class="item">
                            <el-button size="small">待评价订单</el-button>
                        </el-badge>
                    </li>
                    <li>
                        <el-badge @click.native="orderFun(8)" :value="order.refunds" :max="99" class="item">
        ...
        <div class="index-right">
            <div class="Statistics">
                ...
                <ul>
                    <li> 
                        今日营业总额
                        <span class="Orange">{{home_data.profitToday ? home_data.profitToday : '暂无数据'}}</span>
                    </li>
                    <li> 
                        今日订单量
                        <span class="Orange">{{home_data.orderToday ? home_data.orderToday : '暂无数据'}}</span>
                    </li>
                    <li> 
                        今日有效订单量
                        <span class="Orange">{{home_data.userToday ? home_data.userToday : '暂无数据'}}</span>
                    </li>
                </ul>
            </div>
            <div class="Statistics">
            ...
            <div class="Statistics">
                <h3 class="lm c" @click="goGo">销售情况统计<span class="gray">（近7天）</span></h3>
                <el-table
                    max-height="150"
