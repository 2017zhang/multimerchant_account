<template>
    ...
    <div class="tradeManage fl">
        <div class="t_tab">
            <h1 class="t_title">
                <span class="size16">套餐订单退款/退货管理 - 退款、退货列表</span>
            </h1>
            <div class="notes-box">
    ...
    methods: {
        ...
        refund(item) {
            this.$confirm('请确认退款金额', '提示', {
                ...
                this.$HTTP(this.$httpConfig.refundOfPackagegGoods,{id: item.id}).then(res => {
                    this.$message({
                        duration: 1000,
                        type: 'success',
        ...
        //搜索退款/货订单
        search() {
            this.$HTTP(this.$httpConfig.packageOrderReturnList+ '/p/' + this.currentPage,{
