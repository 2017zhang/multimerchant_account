<template>
    <div class="datails">
        <h1 class="t_title">
            <span class="size16">退款/退货详情</span>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="list">
            ...
            <tr>
                ...
                <td colspan="5" class="space">
                    {{new Date(goodsData.create_time * 1000).getFullYear()+'/'+(new Date(goodsData.create_time *
                    1000).getMonth()+1)+'/'+new Date(goodsData.create_time * 1000).getDate()+' '+new
                    Date(goodsData.create_time * 1000).getHours()+':'+new Date(goodsData.create_time *
                    1000).getMinutes()+':'+new Date(goodsData.create_time * 1000).getSeconds()}}
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="5" class="space">
                    <el-input style="width: 350px;" :autosize="{ minRows: 2, maxRows: 5}" type="textarea" :rows="2"
                              placeholder="请输入内容" v-model="goodsData.content">
                    </el-input>
                </td>
            </tr>
            <tr>
...
<script>
    export default {
        ...
        methods: {
            getData() {
                this.$HTTP(this.$httpConfig.getRefundDetail, {id: this.$route.params.id}).then(res => {
                    this.$message({
                        duration: 1000,
                        type: 'success',
            ...
            submit() {
                ...
                this.$HTTP(this.$httpConfig.setRefundGoods, {
