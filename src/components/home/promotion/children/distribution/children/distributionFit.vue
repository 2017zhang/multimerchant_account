        ...
        <div class="t_tab">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="logistics_x" >
                ...
                <tr>
                    ...
                    <td><input type="text" v-model="value1" placeholder="请输入一级分销比例"></td>
                    <td align="left"><span class="notes">单位 : %</span></td>
                </tr>
                <tr>
                    <td align="right" class="black"> 二级分销比例：</td>
                    <td><input type="text" v-model="value2" placeholder="请输入二级分销比例"></td>
                    <td align="left"><span class="notes">单位 : %</span></td>
                </tr>
                <tr>
                    <td align="right" class="black"> 三级分销比例：</td>
                    <td><input type="text" v-model="value3" placeholder="请输入三级分销比例"></td>
                    <td align="left"><span class="notes">单位 : %</span></td>
                </tr>
                <tr>
                    <td align="right" class="black"> 四级分销比例：</td>
                    <td><input type="text" v-model="value4" placeholder="请输入四级分销比例"></td>
                    <td align="left"><span class="notes">单位 : %</span></td>
                </tr>
                <tr>
                    <td align="right" class="black"> 五级分销比例：</td>
                    <td><input type="text" v-model="value5" placeholder="请输入五级分销比例"></td>
                    <td align="left"><span class="notes">单位 : %</span></td>
                </tr>
                <!--<tr>-->
                ...
                <tr>
                    <td align="right">&nbsp;</td>
                    <td><span @click="setMemberConfig()" class="Settled" style="background:#f7bc0a; width:199px;">确认提交</span></td>
                    <td>&nbsp;</td>
                </tr>
            </table>
        </div>
    ...
    export default {
        ...
        methods:{
            setMemberConfig(){ //设置分销
                ...
                this.$HTTP(this.$httpConfig.setMemberConfig,data).then((res)=>{
            ...
            getMemberConfig(){ // 获取分销
                this.$HTTP(this.$httpConfig.distraibutionFit, {}, 'post').then((res) => {
