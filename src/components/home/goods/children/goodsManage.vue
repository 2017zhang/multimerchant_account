<template>
    ...
    <div class="shopManage fl">
                ...
                <div class="fl danj">
                    ...
                    <el-popover placement="top-start" width="100%" trigger="click">
                        <el-table :data="gridData" border>
                            ...
                            <el-table-column show-overflow-tooltip="" width="250" property="title"
                            ...
                            <el-table-column width="80" property="stock" label="审核状态">
        ...
        <div class="Paging">
            ...
            <div class="Paging_r">
                <el-pagination background layout="total,prev, pager, next,jumper" :page-size="page_size"
